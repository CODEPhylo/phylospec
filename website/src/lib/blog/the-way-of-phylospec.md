...
Designing a phylogenetic modeling language means making a lot of decisions. Existing languages and tools offer countless variations in syntax, abstraction levels, model parameterizations and best practices. In a vacuum, no perfect language exists—it only emerges once you have clear priorities and constraints.

This post is an attempt to outline my personal view of what we're trying to achieve with PhyloSpec. This should guide us in making decisions, especially the ones which would otherwise just come down to subjective personal preference.
...
Most components have been already implemented in many different places. This gives us a chance to learn from these implementations.
...
There must be a clearly defined path for external components to be added to the core. This keeps the language evolving and enables innovation without fragmenting the ecosystem or losing stability.
