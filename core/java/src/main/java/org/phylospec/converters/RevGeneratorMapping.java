    ...
    static StringBuilder map(
        ...
        return switch (expr.functionName) {
            ...
            case "zip" -> {
                ...
                RevStmt.Assignment firstListStmt =
                        converter.addRevAssignment(new RevStmt.Assignment("temp_first", first));
                String firstListName = firstListStmt.variableName;

                RevStmt.Assignment secondListStmt =
                        converter.addRevAssignment(new RevStmt.Assignment("temp_second", second));
                ...
                converter.addRevAssignment(
                        new RevStmt.Assignment(
                                "temp_zipped",
                                new String[] {indexVarName, "2"},
                                new StringBuilder(secondListName)
                                        .append("[")
                                        .append(indexVarName)
                                        .append("]")),
                        false);
