...
public class EvaluateLiteralsTest {
    ...
    public void testBinary() {
        ...
        testStatements(
                "Real a = 1 + 12 / 4 - 10 * 2",
                new Stmt.Assignment(new AstType.Atomic("Real"), "a", new Expr.Literal(-16)));
        testStatements(
                "String a = \"A\" + \"B\" + \"C\"",
                new Stmt.Assignment(new AstType.Atomic("String"), "a", new Expr.Literal("ABC")));
        testStatements(
        ...
        testStatements(
                "Boolean a = 10 + 2 != 12",
                new Stmt.Assignment(new AstType.Atomic("Boolean"), "a", new Expr.Literal(false)));
        testStatements(
                "Boolean a = 10 - 2 == 12",
                new Stmt.Assignment(new AstType.Atomic("Boolean"), "a", new Expr.Literal(false)));
        testStatements(
