...
public class TypeUtilsTest {
    ...
    public void testCovers() throws IOException {
        ...
        assertTrue(TypeUtils.covers(
                ...
                ResolvedType.fromString("NonNegativeInteger", componentResolver)
                        .iterator()
                        .next(),
                componentResolver));
        ...
        assertTrue(TypeUtils.covers(
                ResolvedType.fromString("Integer", componentResolver).iterator().next(),
                ResolvedType.fromString("PositiveInteger", componentResolver)
                        .iterator()
                        .next(),
                componentResolver));
        ...
        assertTrue(TypeUtils.covers(
                ResolvedType.fromString("NonNegativeReal", componentResolver)
                        .iterator()
                        .next(),
                ResolvedType.fromString("Probability", componentResolver)
                        .iterator()
                        .next(),
                componentResolver));
        ...
        assertTrue(TypeUtils.covers(
                ResolvedType.fromString("Vector<Probability>", componentResolver)
                        .iterator()
                        .next(),
