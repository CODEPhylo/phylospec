...
- **Extensible component registry** — register new literal types or generator components with a single `register()` call; generator components are auto-registered from `app/core-components.json`.
