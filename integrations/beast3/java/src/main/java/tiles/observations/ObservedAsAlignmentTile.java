...
public class ObservedAsAlignmentTile extends TemplateTile<DecoratedAlignment, BEASTState> {
    ...
    TemplateTileInput<UnboundDistribution<? extends Alignment, ?>, BEASTState> distributionInput =
    ...
    public DecoratedAlignment applyTile(BEASTState beastState, IdentityHashMap<Expr.Variable, Integer> indexVariables) {
        ...
        UnboundDistribution<? extends Alignment, ?> evaluatedDistribution =
        ...
        evaluatedDistribution.observeAs(
                beastState, observedStateNode.alignment(), id); // here we unwrap observedStateNode
