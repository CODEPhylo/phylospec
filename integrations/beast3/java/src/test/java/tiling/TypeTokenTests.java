...
public class TypeTokenTests {
    ...
    public void testTypeIsAssignableFromSubType() {
        ...
        assert new TypeToken<
                ScalarDistribution<
                        beast.base.spec.type.RealScalar<beast.base.spec.domain.Real>, Double>>() {}.isAssignableFrom(
                new TypeToken<Normal>() {});
    }
    ...
    public void testCovariantTypeIsAssignableFromSubType() {
        ...
        assert new TypeToken<
                UnboundDistribution<
                        RealScalarParam<beast.base.spec.domain.Real>,
                        ? extends
                                ScalarDistribution<
                                        beast.base.spec.type.RealScalar<beast.base.spec.domain.Real>,
                                        Double>>>() {}.isAssignableFrom(
                new TypeToken<UnboundDistribution<RealScalarParam<beast.base.spec.domain.Real>, Normal>>() {});
    }
    ...
    public void testInvariantTypeIsNotAssignableFromSubType() {
        ...
        assert !new TypeToken<IntScalarParam<PositiveInt>>() {}.isAssignableFrom(
                new TypeToken<IntScalarParam<Int>>() {});
        assert !new TypeToken<IntScalarParam<Int>>() {}.isAssignableFrom(
                new TypeToken<IntScalarParam<PositiveInt>>() {});
    }
}
