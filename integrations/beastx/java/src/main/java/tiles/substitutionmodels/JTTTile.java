...
public class JTTTile extends GeneratorTile<EmpiricalAminoAcidModel, BeastXState> {
        ...
        if (baseFrequencies == null) {
            ...
            if (baseFrequencies.size() != 20) {
                throw new TileApplicationError(
                        ...
                        List.of("jtt(baseFrequencies=repeat(value=0.05, num=20))")
                );
            }
            ...
            if (!baseFrequencies.isValid()) {
                throw new TileApplicationError(
                        this.getRootNode(),
                        "JTT baseFrequencies must be a valid simplex.",
